...
export const SuccessAlert: React.FC<alertsProps> = ({ SuccessMessage }) => {
    return (
        <div className="flex items-center py-3 px-4 text-sm text-green-800 rounded-3xl bg-green-50 dark:bg-[#240D13] dark:text-green-400" role="alert">
    ...
    return (
        <>
            {meta.touched && meta.error && (
                <div className="mt-2 flex items-center px-4 py-3 overflow-hidden overflow-ellipsis whitespace-nowrap text-sm text-red-800 rounded-2xl bg-red-200 dark:bg-[#240D13] dark:text-red-400">
